# Objetivo: Criar ponto de Restauracao nas maquinas do laboratorio Remotamente.
...
Invoke-Command -ComputerName $online { Checkpoint-Computer -Description "Ponto de Restauracao Remoto" } -Credential $credencial -ThrottleLimit 20
timeout 200
