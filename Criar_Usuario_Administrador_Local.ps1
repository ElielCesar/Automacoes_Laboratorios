# Objetivo: Criar um usuario local administrador em todas as maquinas.
...
# altere o nome do usuario que vc vai criar aqui
Invoke-Command -ComputerName $online { net user NOME_DO_USUARIO SENHA_AQUI /add /Y ; net localgroup Administradores NOME_DO_USUARIO /add } -Credential $credencial
