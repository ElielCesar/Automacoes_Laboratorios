# Objetivo: Listar se um determinado hotfix / update esta instalado nas maquinas do laboratorio.
...
#Coloque aqui qual o hotfix id que vc deseja procurar, existem milhares de hotfixes.
Invoke-Command -ComputerName $online { Get-HotFix -Id $hotfixid | Select-Object pscomputername, hotfixid, installedby | Format-Table -AutoSize } -Credential $credencial
timeout 200
