# Objetivo: Listar o Nome, endereco IP e MAC Address dos computadores.
...
# altere o index da placa de rede conforme sua necessidade, nesse caso o index eh 7 mas pode variar em outros modelos.
Invoke-Command -ComputerName $online { Get-WmiObject -Class win32_networkadapterconfiguration | Where-Object index -EQ 7 | Select-Object pscomputername, ipaddress, macaddress } -Credential $credencial
timeout 200