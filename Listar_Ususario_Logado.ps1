# Objetivo: Listar quais usuarios estao logados no host no momento da execucao do script.
...
Invoke-Command -ComputerName $online { hostname ; query user ; Write-Output "" } -Credential $credencial
timeout 200
