# Objetivo: Obter Serial Number do Windows das Maquinas.
...
Invoke-Command -ComputerName $online { Get-WmiObject win32_operatingsystem | Select-Object pscomputername, caption , serialnumber | Format-Table -AutoSize } -Credential $credencial -ThrottleLimit 10
timeout 100
