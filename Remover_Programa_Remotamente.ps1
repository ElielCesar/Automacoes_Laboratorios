# Objetivo: Remover um programa instalado deletando seus arquivos.
...
##substitua o caminho de Remove-Item pelo caminho da pasta no seu sistema, vá no pc e olhe o caminho.
Invoke-Command -ComputerName $online { Remove-Item C:\"Program Files (x86)"\"Mendeley Desktop"\* -Recurse -force } -Credential $credencial
timeout 200
